...
<head>
    ...
    <title>MLGCL | Admin Dashboard | COVID-19 Contact Tracing System</title>
    <!-- CSS only -->
    ...
    <div class="row">
        ...
        <div class="col-2" style="height:100%; color:white; position:fixed;
         box-shadow:0px 1px 10px gray;z-index:2; background-color:#028ade;">
            ...
            <a href="{{url('admindashboard')}}" class="links-profile navs-item links-dashboard text-decoration-none" style="background-color:whitesmoke; color:#47494a"><div class=" bg-dash"><i class="fa brands fa-windows icon-right  ms-3"></i>Dashboard</div></a>
