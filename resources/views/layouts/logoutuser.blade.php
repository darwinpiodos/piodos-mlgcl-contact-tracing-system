...
<body>
    <div id="app" id="app" style="z-index:10;visibility:visible;">


    
        <nav class="navbar navbar-expand-md navbar-light back-color" >
                    ...
                    <ul class="navbar-nav ml-auto text-light ">
                        ...
                        @else
                            ...
                            <a id="navbarDropdown" class=" text-light nav-link dropdown-toggle name-user" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                ...
                                <div id="app" style="visibility:visible !important; color:red !important;"class="dropdown-menu dropdown-menu-right name-user" aria-labelledby="navbarDropdown">
